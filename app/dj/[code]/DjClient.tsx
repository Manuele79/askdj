...
<div className={`flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between ${isLanding ? "md:mt-3" : "md:mt-[-40px]"}`}>
...
{isLanding && joinMsg && (
  <div className="mt-6 max-w-2xl rounded-2xl border border-yellow-400/35 bg-zinc-950/55 p-4 shadow-[0_0_22px_rgba(250,204,21,0.14)] flex flex-col items-center text-center gap-3">
