...
{/* Titolo */}
<div className="min-w-0 sm:ml-4 lg:ml-40">
  <div className="text-3xl sm:text-4xl lg:text-6xl font-black tracking-tight text-white leading-tight break-words gap-6">
