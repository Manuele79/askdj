                ...
                {sorted.length === 0 ? (
                  ...
                  <ul className="space-y-3 pb-3">
                    {sorted.map((r, idx) => (
                      ...
                      <li
                        key={r.id}
                        className="mx-1 rounded-3xl overflow-hidden border border-yellow-400/40 bg-zinc-950 p-4 pt-6 shadow-[0_14px_45px_rgba(0,0,0,0.35)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_20px_60px_rgba(0,0,0,0.45)] hover:border-yellow-300 animate-[pulse_1.5s_ease-out]"
                      >
  ...
  return (
    <div className="mt-2">
      <button
        ...
        className="rounded-lg border border-rose-400 bg-rose-500 px-2.5 py-1 text-xs font-bold text-rose-400 transition hover:bg-rose-500/25 hover:border-rose-300 hover:text-white"
      >
